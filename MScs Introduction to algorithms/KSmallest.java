import java.util.*;
@SuppressWarnings("resource") //surpress scanner warnings
public class KSmallest 
{
    ...
    public void getUserInput()
    {
        ...
        do
        {
            ...
            System.out.println("Press 4 to search the Kth element in the tree");
            ...
            switch(val)
            {
                ...
                case "3":
                    ...
                    break;
                case "4":
                System.out.println("please enter the Kth number to locate: ");
                int k = acceptInput();
                Node ksmall = kth(root, k);
                System.out.println(ksmall.data);
                break;
                case "5":
