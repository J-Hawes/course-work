...
<head runat="server">
    <title>Melbourne Public Library - Edit Book</title>
    ...
    <div id="main-wrapper">
        ...
        <form id="frmEdit" runat="server">
            <div id="content">
                ...
                <p></p>
                <asp:Button ID="btnEdit" runat="server" Text="Edit Book" CssClass="buttons" OnClick="btnEdit_Click"/>
                <asp:Label ID="lblSuccess" runat="server" Text="" CssClass="Successmsg"></asp:Label>
                <div>
                    <asp:ValidationSummary ID="vsEditBook" runat="server" HeaderText=" Please review and correct the following errors : "/>
                </div>
